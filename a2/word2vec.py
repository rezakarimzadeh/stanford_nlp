...
def naiveSoftmaxLossAndGradient(
    ...
    ### to integer overflow. 
    uoTVc = np.dot(outsideVectors, centerWordVec)
    y_hat = softmax(uoTVc)
...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    currentCenterWord_ind = word2Ind[currentCenterWord]
    centerWordVec = centerWordVectors[currentCenterWord_ind]
    for outsideWord in outsideWords:
        outsideWordIdx = word2Ind[outsideWord]
        l, gradCenterVec, gradOutsideVecs = word2vecLossAndGradient(centerWordVec,
                                                                        outsideWordIdx,
                                                                        outsideVectors,
                                                                        dataset,)
        loss += l
        gradCenterVecs[currentCenterWord_ind] += gradCenterVec
